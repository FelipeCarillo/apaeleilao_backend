...
class CreateUserUseCase:
    ...
    def __call__(self, email: str, cpf: str, first_name: str, last_name: str, password: str, accept_terms: bool,
                 is_verified: bool):
        ...
        user = User(user_id=user_id, email=email, cpf=cpf, first_name=first_name, last_name=last_name,
                    password=password, accepted_terms=accept_terms, is_verified=is_verified, date_joined=date_joined,
