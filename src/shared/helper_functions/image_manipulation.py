...
class ImageManipulation:
    ...
    def create_auction_folder(self, auction_id: str):
        try:
            ...
            self.__s3.Object(self.__bucket, auction_folder_key).put(Body='')
    ...
    def upload_auction_image(self, auction_id: str, image_id: str, image_body: str, content_type: str):
        try:
            ...
            self.__s3.put_object(Bucket=self.__bucket, Key=image_key,
                                 Body=base64.b64decode(image_body), ContentType=content_type)
